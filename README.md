...
[![Types](https://flat.badgen.net/npm/types/@extended-lib/react-hooks)](https://www.npmjs.com/package/@extended-lib/react-hooks)
[![Tree Shaking](https://flat.badgen.net/bundlephobia/tree-shaking/@extended-lib/react-hooks)](https://bundlephobia.com/result?p=@extended-lib/react-hooks)

× **[DOCS](https://github.com/RohitV5/-extended-lib-react-hooks)** × **[DISCORD](https://rohitv5.web.app/)** ×

</div>

---

`@extended-lib/react-hooks` is a library of general-purpose React hooks built with care and SSR compatibility
in mind.
...
```shell
npm i @extended-lib/react-hooks
# or
yarn add @extended-lib/react-hooks
```

As hooks was introduced to the world in React 16.8, `@extended-lib/react-hooks` requires - you guessed it -
`react` and `react-dom` 16.8+.
Also, as React does not support IE, `@extended-lib/react-hooks` does not do so either. You'll have to
...
import { useMountEffect } from '@extended-lib/react-hooks';
// in case you need esm modules
import { useMountEffect } from '@extended-lib/react-hooks/esm';
// in case you want all the recent ES features
import { useMountEffect } from '@extended-lib/react-hooks/esnext';
```
